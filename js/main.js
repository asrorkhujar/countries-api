// GLOBAL VARS
let COUNTRIES_BASE_URL = 'https://restcountries.com/v3.1/name/';
...
function updateCountryModal(data) {
  ...
  elCountryModal.querySelector('.country__details-currency').textContent = data[0].currencies.name;
